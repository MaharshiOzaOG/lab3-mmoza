...
def collate_fn(
    ...
    input_ids_padded = input_ids_padded = pad_sequence(input_ids, batch_first=True, padding_value=pad_token_id)  # STUDENT TODO

    # STUDENT TODO: Pad target_ids
    target_ids_padded = pad_sequence(target_ids, batch_first=True, padding_value=pad_token_id)  # STUDENT TODO

...
class TextGenerator:
    ...
    def generate(
        ...
        input_ids = torch.tensor([input_ids], device=self.device)  # STUDENT TODO: torch.tensor([input_ids], device=self.device)
    ...
    def _top_p_filtering(self, logits: torch.Tensor, top_p: float) -> torch.Tensor:
        ...
        filtered_logits.scatter_(dim=-1, index=sorted_indices, src=sorted_logits)  # STUDENT TODO

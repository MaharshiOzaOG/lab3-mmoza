...
class LanguageModelingLoss(nn.Module):
    ...
    def forward(
        ...
        loss = F.cross_entropy(logits, targets, ignore_index=self.pad_token_id, label_smoothing=self.label_smoothing)  # STUDENT TODO
...
class MetricsTracker:
    ...
    def update(self, **kwargs):
        ...
        for name, value in kwargs.items():
            ...
            self.metrics[name] += value  # STUDENT TODO
